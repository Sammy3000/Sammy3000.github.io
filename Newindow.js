...
const modalContent = (project) => {
  ...
  <div class="modal-content">
    ...
    <div class="modal-button">
      <a href="${project.demo}" class="modal-btn"><span>See Demo</span>  <img src="images/Icon.png" alt="live"></a>
      <a href="${project.source}" class="modal-btn"><span>See Source</span> <img src="images/git.png" alt="github link"> </a>
    </div>
  </div>
  </div> `;
